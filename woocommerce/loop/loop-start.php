...
$product_variant = $bicycleshop_a13->get_option( 'shop_products_variant' );
$product_subvariant = $product_variant === 'under'? ('products_subvariant_'.$bicycleshop_a13->get_option( 'shop_products_subvariant' ) ) : '';
...
$lazy_load_mode  = $bicycleshop_a13->get_option( 'shop_lazy_load_mode' );
