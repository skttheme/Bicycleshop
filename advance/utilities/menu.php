...
if(!function_exists('bicycleshop_add_menu_parent_class')){
	/**
	 ...
	 * @return array
	 */
	function bicycleshop_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'bicycleshop_add_menu_parent_class' );


if(!function_exists('bicycleshop_page_menu')){
	/**
	 ...
	 */
	function bicycleshop_page_menu($only_check = false) {
        global $post;
        ...
        if($there_is_menu){
            ...
            $list_pages_params['walker'] = new BICYCLESHOP_list_pages_walker;
